...
const LoginPage: React.FC = () => {
    ...
    const PaswordinputChangeHandler = (e: any) => {
        dispatch(
            registerSlice.actions.passwordCheckChangeHandler(
    ...
    const sendSigninRequest = async (e: React.FormEvent<HTMLFormElement>) => {
        console.log(register.emailCheck, register.passwordCheck);
        e.preventDefault();
        try {
            const response = await fetch('http://localhost:3000/api/customer', {
                ...
                body: JSON.stringify({
                    ...
                    password: register.passwordCheck.toString(),
                }),
            });
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-50">
            <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
                ...
                <div className="flex border-b mb-4">
                    <h2 className="text-center text-gray-800">Giriş yap</h2>
                </div>

                <form onSubmit={sendSigninRequest}>
                    <div className="mb-4">
                        <label
                            htmlFor="email"
                        ...
                        <input
                            type="email"
                            id="email"
                            className="w-full px-3 py-2 mt-1 text-sm border rounded-md focus:ring-orange-500 focus:outline-none focus:border-orange-500 text-gray-900"
                    ...
                    <div className="mb-4">
                        ...
                        <div className="relative">
                            <input
                                type={isPasword}
                                id="password"
                                className="w-full px-3 py-2 text-sm border rounded-md focus:ring-orange-500 focus:outline-none focus:border-orange-500 text-gray-800"
                                placeholder="Şifre"
                                value={paswordInput}
